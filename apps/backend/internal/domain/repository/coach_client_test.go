...
func (m *mockCoachClientRepository) FindByCoachAndClient(_ context.Context, _, _ string) (*entities.CoachClient, error) {
	if m.shouldError {
		return nil, errors.New("find error")
	}
	return &entities.CoachClient{ID: "mock-id"}, nil
}
