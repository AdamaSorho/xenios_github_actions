...
type WearableSummaryRepository interface {
	...
	// FindByClientID retrieves wearable summaries for a client with optional date range.
	FindByClientID(ctx context.Context, clientID string, days int) ([]*entities.WearableSummary, error)
}
