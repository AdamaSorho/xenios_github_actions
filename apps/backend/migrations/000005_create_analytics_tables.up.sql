...
CREATE RULE events_audit_no_update AS ON UPDATE TO events_audit DO INSTEAD NOTHING;
CREATE RULE events_audit_no_delete AS ON DELETE TO events_audit DO INSTEAD NOTHING;
